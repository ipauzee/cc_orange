 ...
 * @author jsm
 */
public class cccs_Media extends javax.swing.JFrame {
...
//        tabelmedia();
    ...
    public cccs_Media(ContactCenterOrangeTv ccanj){
        this();
        this.CCanj=ccanj;
    }
    private cccs_ticket Tic;
    public cccs_Media(cccs_ticket tic){
        this();
        this.Tic=tic;
    }

    private cccs_Add_note Add;
    public cccs_Media(cccs_Add_note add){
        this();
        this.Add=add;
    }
    ...
    private void initComponents() {
        ...
        tblmedia.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cccs_Media().setVisible(true);
            }
        });
    }
