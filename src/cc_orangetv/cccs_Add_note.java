 ...
 * @author jsm
 */
public class cccs_Add_note extends javax.swing.JFrame {

        public static int status=0;
    private int asdep;
    private String solution;

    /** Creates new form cccs_Add_note */
    public cccs_Add_note() {
        initComponents();
    }

    private cccs_History Hic;
    public cccs_Add_note(cccs_History hic){
        this();
        this.Hic=hic;
    }
    public static ContactCenterOrangeTv CCanj;
    public cccs_Add_note(ContactCenterOrangeTv ccanj){
        this();
        this.CCanj=ccanj;
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cccs_Add_note().setVisible(true);
            }
        });
    }
