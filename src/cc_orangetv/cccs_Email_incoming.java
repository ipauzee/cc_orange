 ...
 * @author jsm
 */
public class cccs_Email_incoming extends javax.swing.JFrame {
    public static int z;
    ...
    /** Creates new form cccs_Email_incoming */
    public cccs_Email_incoming() {
        initComponents();
        zz=-1;
        showCaltype();
        showCust();
    ...
    public cccs_Email_incoming(cccs_Search_ticket sct){
        this();
        this.Sct=sct;
    }
    public static cccs_login Log;
    public cccs_Email_incoming(cccs_login log){
        this();
        this.Log=log;
    }
    public static ContactCenterOrangeTv CCanj;
    public cccs_Email_incoming(ContactCenterOrangeTv ccanj){
        this();
        this.CCanj=ccanj;
    }
    public static cccs_EMail Mail;
    public cccs_Email_incoming(cccs_EMail mail){
        this();
        this.Mail=mail;
    }
    private cccs_ticket Tic;
    public cccs_Email_incoming(cccs_ticket tic){
        this();
        this.Tic=tic;
    }
    ...
    private void initComponents() {
        ...
        txtsubject.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        ...
        jButton1.setBounds(10, 470, 131, 0);
        ...
        jButton2.setBounds(640, 470, 133, 0);
        ...
        txtfrom.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        jPanel1.add(txtfrom);
        ...
        jLabel16.setBounds(10, 130, 100, 0);
        ...
        txtcc.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        jPanel1.add(txtcc);
        ...
        scpCcList1.setBounds(110, 130, 500, 0);
...
//                System.out.print(zz);
                if(zz==-1){
                    sql = "update log_mail set"
                            + " status=2 ,direction_type='"+cbcaltype.getSelectedItem()+"'"
//                            + ", cust_name='"+cbcust.getSelectedItem()+"' "
                    ...
                    sql = "update log_mail set"
                            + " status=2 , ticket_id='"+zz+"', ticket_no=(select ticket_no from tickets where ticket_id='"+zz+"') ,direction_type='"+cbcaltype.getSelectedItem()+"'" +
//                            + ", cust_name='"+cbcust.getSelectedItem()+"' " +
                        "where mail_id='"+mid+"'";
                    CCanj.jconn.SQLExecute(sql, CCanj.conn);
//                    
...
//        }
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        if(selected==true){
            ...
            JOptionPane.showMessageDialog(null, "Please select Sendertype", "Outgoing Email",JOptionPane.WARNING_MESSAGE);
        }
...
Object sel1;int baris;int conter;
    ...
    private void btnAttachmentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAttachmentActionPerformed
        ...
        if (chooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            CCanj.s = "DOWNLOAD|EMAIL|0|"+att+"|"+fullnmfile+"|"+Log.ftpserver+"|"+Log.ftpuser+"\r\n";
            CCanj.kirimUplo();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cccs_Email_incoming().setVisible(true);
            }
        });
    }
