 ...
 * @author jsm
 */
public class cccs_FAX1 extends javax.swing.JFrame {
    String s;
    String nmfile;
    String fullnmfile;
   ...
   Timer receiv;
    ...
    public cccs_FAX1(ContactCenterOrangeTv ccanj){
        this();
        this.CCanj=ccanj;
    }
    private cccs_ticket Tic;
    public cccs_FAX1(cccs_ticket tic){
        this();
        this.Tic=tic;
    }
    ...
    private void initComponents() {
        ...
        btnopen.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        ...
        btnupload.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
