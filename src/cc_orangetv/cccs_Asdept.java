 ...
 * @author jsm
 */
public class cccs_Asdept extends javax.swing.JFrame {
...
//        conn=(Connection) jconn.ConnectToMySQL("192.168.0.234","cc_anj","cc_anj","123jaring456");
    ...
    public cccs_Asdept(ContactCenterOrangeTv ccanj){
        this();
        this.CCanj=ccanj;
    }
    ...
    private void initComponents() {
        ...
        Cancel.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cccs_Asdept().setVisible(true);
            }
        });
    }
