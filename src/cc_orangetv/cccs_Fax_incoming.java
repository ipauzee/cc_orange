 ...
 * @author jsm
 */
public class cccs_Fax_incoming extends javax.swing.JFrame {
    public static int z;
    ...
    /** Creates new form cccs_Fax_incoming */
    public cccs_Fax_incoming() {
        initComponents();
        showCust();
        setSize(1024,768);
    }
    ...
    public cccs_Fax_incoming(ContactCenterOrangeTv ccanj){
        this();
        this.CCanj=ccanj;
    }
    public static cccs_Search_ticket Sct;
    public cccs_Fax_incoming(cccs_Search_ticket sct){
        this();
        this.Sct=sct;
    }
    private cccs_ticket Tic;
    public cccs_Fax_incoming(cccs_ticket tic){
        this();
        this.Tic=tic;
    }
    private cccs_FAX Fax;
    public cccs_Fax_incoming(cccs_FAX fax){
        this();
        this.Fax=fax;
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cccs_Fax_incoming().setVisible(true);
            }
        });
    }
...
//    public static Connection conn;
    ...
    public static void open(){
        ...
        try {
            ...
            Logger.getLogger(cccs_Fax_incoming.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    private void opdt(){
          try{
