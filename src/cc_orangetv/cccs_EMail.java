 ...
 * @author jsm
 */
public class cccs_EMail extends javax.swing.JFrame {
    ...
    public cccs_EMail(cccs_login log){
        this();
        this.Log=log;
    }
    public static ContactCenterOrangeTv CCanj;
    public cccs_EMail(ContactCenterOrangeTv ccanj){
        this();
        this.CCanj=ccanj;
    }
    public static cccs_ticket Tic;
    public cccs_EMail(cccs_ticket tic){
        this();
        this.Tic=tic;
    }
    ...
    private void initComponents() {
        ...
        paneloutbox.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        ...
        btnmsend.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        ...
        btnccancc.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        ...
        txtcmsg.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        txtcmsg.setRows(5);
        ...
        txtccc.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        jPanel1.add(txtccc);
        txtccc.setBounds(110, 30, 410, 25);

        jLabel10.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        jLabel10.setText("Cc :");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(10, 30, 100, 20);
        ...
        txtcsu.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        jPanel1.add(txtcsu);
        txtcsu.setBounds(110, 50, 600, 25);
        ...
        btnsrchcus.setBounds(690, 10, 20, 0);
        ...
        btnsrchcus1.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        ...
        jLabel23.setBounds(520, 30, 70, 0);
        ...
        txtIdCust.setBounds(590, 30, 120, 0);
...
//        lbldirection.setText("OutBound");
    ...
    private void btnmsendMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnmsendMouseClicked
        ...
        optm();
        stt();
        sql="insert into log_mail (mail_date,mail_time,mail_from,mail_to,mail_cc,mail_subject,mail_text,direction,username,ticket_id,direction_type"
                + ",ticket_no,bikepoint_id)"
                + " values"
                + " (CURRENT_DATE,CURRENT_TIME,'distributor@orangetv.co.id','"+txtcto.getText()+"','"+txtccc.getText()+"','"+txtcsu.getText()+"','"+txtcmsg.getText()+"',1,'"+CCanj.lbluser.getText()+"','"+id+"','"+cbcaltype.getSelectedItem()+"'"
...
//        sql1="insert into log_mail (mail_from,mail_to,mail_subject,mail_text,ticket_id,direction,username) values ('contact@anjrent.com','"+txtcsomail.getText()+"','<Ticket>#"+txtcusnam.getText()+"#"+cbnoplat.getSelectedItem()+"#"+txtusr.getText()+"#"+cbcategory.getSelectedItem()+"#"+txtnotic.getText()+"','"+txtdetails.getText()+"\n\n"+txtsolution.getText()+" \n\n UPDATED','"+id+"',1,'"+CCanj.lbluser.getText()+"')";
        ...
        try {
            ...
            Logger.getLogger(cccs_EMail.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        if(!txtAttachment.getText().equals("")){
            receiv.start();
            CCanj.s = "UPLOAD|EMAIL|"+fullnmfile+"|"+Log.ftpserver+"|"+Log.ftpuser+"\r\n";
            CCanj.kirimUplo();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cccs_EMail().setVisible(true);
            }
        });
    }
