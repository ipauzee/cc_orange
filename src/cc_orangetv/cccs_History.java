 ...
 * @author jsm
 */
public class cccs_History extends javax.swing.JFrame {
    ...
    public cccs_History(ContactCenterOrangeTv ccanj){
        this();
        this.CCanj=ccanj;
    }
    private cccs_ticket Tic;
    public cccs_History(cccs_ticket tic){
        this();
        this.Tic=tic;
    }

    private cccs_Add_note Add;
    public cccs_History(cccs_Add_note add){
        this();
        this.Add=add;
    }
    ...
    private void initComponents() {
        ...
        lblclo.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        jPanel1.add(lblclo);
        lblclo.setBounds(20, 120, 330, 20);

        lblprocess.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        jPanel1.add(lblprocess);
        lblprocess.setBounds(20, 90, 330, 20);

        lblopen.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        jPanel1.add(lblopen);
        ...
        lblticno.setFont(new java.awt.Font("Calibri", 1, 12)); // NOI18N
        ...
        txtinfo.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
    ...
    private void btnsaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnsaveMouseClicked
        ...
        optm();
        usrlvl();
        cccs_Add_note add=new cccs_Add_note();
        add.setVisible(true);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cccs_History().setVisible(true);
            }
        });
    }
